        ...
        <div class="col-12">
          <form action="{{ route('register.post') }}" class="form-contact contact_form" method="post"  novalidate="novalidate">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group">
                  <input class="form-control border" name="password" type="password" value="{{ old('password') }}" placeholder="Enter your password">
                  @error('password')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group">
                  <input class="form-control border" name="password_confirmation" type="password" value="{{ old('password_confirmation') }}" placeholder="Enter your password confirmation">
            ...
            <div class="form-group text-center text-md-right mt-3">
              <a href="{{ route('theme.login') }}" class="btn btn-sm btn-warning">already have an account?</a>
